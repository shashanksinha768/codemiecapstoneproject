...
-- Sample seeding for property_type/review_score + amenity mapping.

PRAGMA foreign_keys = ON;

UPDATE accommodations SET property_type = 'hotel', review_score = 8.6 WHERE id = 1;
UPDATE accommodations SET property_type = 'villa', review_score = 9.1 WHERE id = 2;
